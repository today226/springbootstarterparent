...
<head>
    ...
    <script type="text/javascript"          src="${pageContext.request.contextPath}/js/common/jqGrid/i18n/grid.locale-en.js"></script>
    ...
    <script type="text/javascript">
        ...
        function fn_SearchList(){
            //$(gridOptions).attr("postData", jQuery('#srchForm').serializeFormJSON());
            $("#jqGridList").jqGrid(gridOptions).navGrid("",
                {
                    search:false,
                    edit:false,
                    add:false,
